...
<form action="<?php echo BASE_URL; ?>ventas/actualizarVenta/<?php echo $venta['ventaId']; ?>" method="POST">
    <div class="row">
        ...
        <div class="mb-3 col-md-4">
            ...
            <input type="date" class="form-control" id="fechaVenta" name="fechaVenta" required value="<?= $venta['fechaVenta']; ?>">
        </div>
    </div>
    ...
    <div class="row">
        <div class="mb-3 col-md-4">
            ...
            <textarea name="direccionEntrega" class="form-control" id="direccionEntrega" rows="2" required><?= $venta['direccionEntrega']; ?></textarea>
        </div>
        <div class="mb-3 col-md-4">
            <label for="fechaEstimada" class="form-label">Fecha Estimada de entrega:</label>
            <input type="date" class="form-control" id="fechaEstimada" name="fechaEstimada" required value="<?= $venta['fechaEntregaEstimada']; ?>">
        </div>
    </div>
    <div class="row">
        <fieldset class="border p-3 rounded">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <input type="number" class="form-control" id="cantidad" name="cantidad" required value="<?= $venta['detalle'][0]['cantidad']; ?>" min ="1">
                </div>
            </div>
        </fieldset>
    </div>
    <button type="submit" class="btn btn-success mt-4 mb-4">Guardar Venta</button>
    <button type="reset" class="btn btn-secondary mt-4 mb-4">Limpiar</button>
    <a href="<?php echo BASE_URL; ?>ventas/listarVentas" class="btn btn-danger mt-4 mb-4">Cancelar</a>
</form>
